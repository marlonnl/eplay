...
const Categories = () => (
  <>
    <ProductList title="RPG" games={sales} bg="grey" />
    <ProductList title="Ação" games={comingSoon} bg="black" />
    <ProductList title="Aventura" games={sales} bg="grey" />
    <ProductList title="FPS" games={comingSoon} bg="black" />
  </>
)
